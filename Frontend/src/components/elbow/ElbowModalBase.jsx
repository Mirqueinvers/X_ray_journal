// Frontend/src/components/elbow/ElbowModalBase.jsx
...
export function useElbowModalState() {
...
export default function ElbowModalBase({
  isOpen,
  onClose,
  title,
  onAdd,
  ...
  return (
    ...
    >
      ...
      >
        {/* Правый сустав */}
        <JointArea side="right" style={{ left: "29.5%" }} />

        {/* Левый сустав */}
        <JointArea side="left" style={{ left: "58.5%" }} />
