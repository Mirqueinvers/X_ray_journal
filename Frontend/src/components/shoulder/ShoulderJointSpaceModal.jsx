// Frontend/src/components/shoulder/ShoulderJointSpaceModal.jsx
import React, { useState } from "react";
import BaseModal from "../common/BaseModal";

export default function ShoulderJointSpaceModal({
  isOpen,
  onClose,
  ...
  const generateDescription = () => {
    ...
    Object.keys(sides).forEach((side) => {
      ...
      const textParts = [];
      if (degree && degree !== "не изменена")
        textParts.push(degree.replace(" сужена", ""));
